...
class OTAFV2Config:
    ...
    image_dir: str = "/path/to/private_data/PPGL/ALL_PUMCH_mutil/images"
    label_dir: str = "/path/to/private_data/PPGL/ALL_PUMCH_mutil/labels_multiV4"
    ...
    old_gcp_python: str = "/path/to/miniconda3/envs/ppgl/bin/python"
    old_gcp_center: str = "PUMCH_V3"
    old_gcp_split: str = "test"
    old_gcp_exp_name: str = "gcp_patch256"
    old_gcp_data_root: str = "/path/to/private_data/PPGL/ALL_PUMCH_mutil"
    ...
    totalseg_root: str = "/path/to/TotalSegmentator"
    totalseg_python: str = ""
