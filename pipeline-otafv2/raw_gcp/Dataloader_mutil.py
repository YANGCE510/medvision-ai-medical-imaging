    ...
    def __call__(self, data):
        ...
        for key in self.keys:
            ...
            d[f"{key}_meta_dict"] = {
                ...
                "original_affine": np.asarray(nifti.affine, dtype=np.float64),
    ...
    if partial_label_mode:
        return Compose(
            [
                ...
                DeleteItemsd(keys=["label_union_valid", "label_sampling_valid", "label_small_valid", "partial_sampling_mode"]),
            ]
        )
