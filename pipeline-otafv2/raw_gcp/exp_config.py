...
EXPERIMENT_PRESETS = {
    ...
    "gcp_patch256_adrenal_aux_masked_dicece_lambda0.2": _preset(
        "gcp_patch256_adrenal_aux_masked_dicece_lambda0.2",
        256,
    ),
    "gcp_patch256_adrenal_aux_masked_dicece_lambda0.1": _preset(
        "gcp_patch256_adrenal_aux_masked_dicece_lambda0.1",
        256,
    ),
...
def _validate_cfg(cfg: InferenceConfig) -> None:
    ...
    if not (1 <= cfg.tumor_label < cfg.num_classes):
        raise ValueError(
