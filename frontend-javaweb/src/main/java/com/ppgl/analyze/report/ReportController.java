...
public class ReportController {
    ...
    public ResponseEntity<Resource> overlay(@PathVariable Long taskId, @AuthenticationPrincipal Jwt jwt) {
        Long doctorId = doctorId(jwt);
    ...
    public ResponseEntity<Resource> image(@PathVariable Long taskId, @AuthenticationPrincipal Jwt jwt) {
        Long doctorId = doctorId(jwt);
        return ResponseEntity.ok()
    ...
    public ResponseEntity<Resource> segmentation(@PathVariable Long taskId, @AuthenticationPrincipal Jwt jwt) {
        Long doctorId = doctorId(jwt);
        return ResponseEntity.ok()
    ...
    public ResponseEntity<Resource> mesh(@PathVariable Long taskId, @AuthenticationPrincipal Jwt jwt) {
        Long doctorId = doctorId(jwt);
        return ResponseEntity.ok()
    ...
    public ResponseEntity<Resource> meshManifest(@PathVariable Long taskId, @AuthenticationPrincipal Jwt jwt) {
        Long doctorId = doctorId(jwt);
        return ResponseEntity.ok()
